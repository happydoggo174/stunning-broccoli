...
<script setup>
    ...
    function challenge(){router.push("/challenge").then();}
    function learn(){router.push("/learn").then();}
    function home(){router.push("/").then();}
...
<template>
    <nav id="nav-bar" class="row">
        <div class="row">
            ...
            <button class="nav-btn" @click="challenge">challenge</button>
